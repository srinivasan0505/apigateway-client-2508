/**
 * MCP Server function for Changes information about an ApiKey resource.
 */
...
class Patch_Apikeys_Api_KeyMCPTool {
    
    public static Function<MCPServer.MCPRequest, MCPServer.MCPToolResult> getPatch_Apikeys_Api_KeyHandler(MCPServer.APIConfig config) {
        return (request) -> {
            try {
        ...
        if (args.containsKey("patchOperations")) {
            queryParams.add("patchOperations=" + args.get("patchOperations"));
                ...
                String url = config.getBaseUrl() + "/api/v2/patch_apikeys_api_key" + queryString;
    ...
    public static MCPServer.Tool createPatch_Apikeys_Api_KeyTool(MCPServer.APIConfig config) {
        ...
        api_KeyProperty.put("description", "The identifier of the ApiKey resource to be updated.");
        ...
        MCPServer.ToolDefinition definition = new MCPServer.ToolDefinition(
            "patch_apikeys_api_key",
            "Changes information about an ApiKey resource.",
            parameters
        );
        
        return new MCPServer.Tool(definition, getPatch_Apikeys_Api_KeyHandler(config));
    }
