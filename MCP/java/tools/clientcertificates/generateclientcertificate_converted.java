/**
 * MCP Server function for Generates a ClientCertificate resource.
 */
...
class Post_ClientcertificatesMCPTool {
    
    public static Function<MCPServer.MCPRequest, MCPServer.MCPToolResult> getPost_ClientcertificatesHandler(MCPServer.APIConfig config) {
        return (request) -> {
            try {
        ...
        if (args.containsKey("tags")) {
            queryParams.add("tags=" + args.get("tags"));
                ...
                String url = config.getBaseUrl() + "/api/v2/post_clientcertificates" + queryString;
    ...
    public static MCPServer.Tool createPost_ClientcertificatesTool(MCPServer.APIConfig config) {
        ...
        descriptionProperty.put("description", "Input parameter: The description of the ClientCertificate.");
        ...
        MCPServer.ToolDefinition definition = new MCPServer.ToolDefinition(
            "post_clientcertificates",
            "Generates a ClientCertificate resource.",
            parameters
        );
        
        return new MCPServer.Tool(definition, getPost_ClientcertificatesHandler(config));
    }
