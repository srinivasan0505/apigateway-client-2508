/**
 * MCP Server function for Gets a collection of ClientCertificate resources.
 */
...
class Get_ClientcertificatesMCPTool {
    
    public static Function<MCPServer.MCPRequest, MCPServer.MCPToolResult> getGet_ClientcertificatesHandler(MCPServer.APIConfig config) {
        return (request) -> {
            try {
        ...
        if (args.containsKey("limit")) {
            queryParams.add("limit=" + args.get("limit"));
                ...
                String url = config.getBaseUrl() + "/api/v2/get_clientcertificates" + queryString;
    ...
    public static MCPServer.Tool createGet_ClientcertificatesTool(MCPServer.APIConfig config) {
        ...
        return new MCPServer.Tool(definition, getGet_ClientcertificatesHandler(config));
    }
