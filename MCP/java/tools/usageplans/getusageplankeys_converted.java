/**
 * MCP Server function for Gets all the usage plan keys representing the API keys added to a specified usage plan.
 */
...
class Get_Usageplans_Usageplan_Id_KeysMCPTool {
    
    public static Function<MCPServer.MCPRequest, MCPServer.MCPToolResult> getGet_Usageplans_Usageplan_Id_KeysHandler(MCPServer.APIConfig config) {
        return (request) -> {
            try {
        ...
        if (args.containsKey("limit")) {
            queryParams.add("limit=" + args.get("limit"));
                ...
                String url = config.getBaseUrl() + "/api/v2/get_usageplans_usageplan_id_keys" + queryString;
    ...
    public static MCPServer.Tool createGet_Usageplans_Usageplan_Id_KeysTool(MCPServer.APIConfig config) {
        ...
        usageplanIdProperty.put("description", "The Id of the UsagePlan resource representing the usage plan containing the to-be-retrieved UsagePlanKey resource representing a plan customer.");
        ...
        nameProperty.put("description", "A query parameter specifying the name of the to-be-returned usage plan keys.");
        ...
        MCPServer.ToolDefinition definition = new MCPServer.ToolDefinition(
            "get_usageplans_usageplan_id_keys",
            "Gets all the usage plan keys representing the API keys added to a specified usage plan.",
            parameters
        );
        
        return new MCPServer.Tool(definition, getGet_Usageplans_Usageplan_Id_KeysHandler(config));
    }
