/**
 * MCP Server function for Updates a usage plan of a given plan Id.
 */
...
class Patch_Usageplans_Usageplan_IdMCPTool {
    
    public static Function<MCPServer.MCPRequest, MCPServer.MCPToolResult> getPatch_Usageplans_Usageplan_IdHandler(MCPServer.APIConfig config) {
        return (request) -> {
            try {
        ...
        if (args.containsKey("patchOperations")) {
            queryParams.add("patchOperations=" + args.get("patchOperations"));
                ...
                String url = config.getBaseUrl() + "/api/v2/patch_usageplans_usageplan_id" + queryString;
    ...
    public static MCPServer.Tool createPatch_Usageplans_Usageplan_IdTool(MCPServer.APIConfig config) {
        ...
        usageplanIdProperty.put("description", "The Id of the to-be-updated usage plan.");
        ...
        MCPServer.ToolDefinition definition = new MCPServer.ToolDefinition(
            "patch_usageplans_usageplan_id",
            "Updates a usage plan of a given plan Id.",
            parameters
        );
        
        return new MCPServer.Tool(definition, getPatch_Usageplans_Usageplan_IdHandler(config));
    }
