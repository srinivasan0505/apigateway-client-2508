/**
 * MCP Server function for Gets all the usage plans of the caller's account.
 */
...
class Get_UsageplansMCPTool {
    
    public static Function<MCPServer.MCPRequest, MCPServer.MCPToolResult> getGet_UsageplansHandler(MCPServer.APIConfig config) {
        return (request) -> {
            try {
        ...
        if (args.containsKey("limit")) {
            queryParams.add("limit=" + args.get("limit"));
                ...
                String url = config.getBaseUrl() + "/api/v2/get_usageplans" + queryString;
    ...
    public static MCPServer.Tool createGet_UsageplansTool(MCPServer.APIConfig config) {
        ...
        keyIdProperty.put("description", "The identifier of the API key associated with the usage plans.");
        ...
        return new MCPServer.Tool(definition, getGet_UsageplansHandler(config));
    }
