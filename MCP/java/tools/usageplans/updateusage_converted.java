/**
 * MCP Server function for Grants a temporary extension to the remaining quota of a usage plan associated with a specified API key.
 */
...
class Patch_Usageplans_Usageplan_Id_Keys_Key_Id_UsageMCPTool {
    
    public static Function<MCPServer.MCPRequest, MCPServer.MCPToolResult> getPatch_Usageplans_Usageplan_Id_Keys_Key_Id_UsageHandler(MCPServer.APIConfig config) {
        return (request) -> {
            try {
        ...
        if (args.containsKey("patchOperations")) {
            queryParams.add("patchOperations=" + args.get("patchOperations"));
                ...
                String url = config.getBaseUrl() + "/api/v2/patch_usageplans_usageplan_id_keys_key_id_usage" + queryString;
    ...
    public static MCPServer.Tool createPatch_Usageplans_Usageplan_Id_Keys_Key_Id_UsageTool(MCPServer.APIConfig config) {
        ...
        keyIdProperty.put("description", "The identifier of the API key associated with the usage plan in which a temporary extension is granted to the remaining quota.");
        ...
        MCPServer.ToolDefinition definition = new MCPServer.ToolDefinition(
            "patch_usageplans_usageplan_id_keys_key_id_usage",
            "Grants a temporary extension to the remaining quota of a usage plan associated with a specified API key.",
            parameters
        );
        
        return new MCPServer.Tool(definition, getPatch_Usageplans_Usageplan_Id_Keys_Key_Id_UsageHandler(config));
    }
