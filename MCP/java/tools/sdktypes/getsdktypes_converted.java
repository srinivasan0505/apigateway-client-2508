/**
 * MCP Server function for Gets SDK types
 */
...
class Get_SdktypesMCPTool {
    
    public static Function<MCPServer.MCPRequest, MCPServer.MCPToolResult> getGet_SdktypesHandler(MCPServer.APIConfig config) {
        return (request) -> {
            try {
        ...
        if (args.containsKey("limit")) {
            queryParams.add("limit=" + args.get("limit"));
                ...
                String url = config.getBaseUrl() + "/api/v2/get_sdktypes" + queryString;
    ...
    public static MCPServer.Tool createGet_SdktypesTool(MCPServer.APIConfig config) {
        ...
        return new MCPServer.Tool(definition, getGet_SdktypesHandler(config));
    }
