/**
 * MCP Server function for Updates an existing Method resource.
 */
...
class Patch_Restapis_Restapi_Id_Resources_Resource_Id_Methods_Http_MethodMCPTool {
    
    public static Function<MCPServer.MCPRequest, MCPServer.MCPToolResult> getPatch_Restapis_Restapi_Id_Resources_Resource_Id_Methods_Http_MethodHandler(MCPServer.APIConfig config) {
        return (request) -> {
            try {
        ...
        if (args.containsKey("patchOperations")) {
            queryParams.add("patchOperations=" + args.get("patchOperations"));
                ...
                String url = config.getBaseUrl() + "/api/v2/patch_restapis_restapi_id_resources_resource_id_methods_http_method" + queryString;
    ...
    public static MCPServer.Tool createPatch_Restapis_Restapi_Id_Resources_Resource_Id_Methods_Http_MethodTool(MCPServer.APIConfig config) {
        ...
        MCPServer.ToolDefinition definition = new MCPServer.ToolDefinition(
            "patch_restapis_restapi_id_resources_resource_id_methods_http_method",
            "Updates an existing Method resource.",
            parameters
        );
        
        return new MCPServer.Tool(definition, getPatch_Restapis_Restapi_Id_Resources_Resource_Id_Methods_Http_MethodHandler(config));
    }
