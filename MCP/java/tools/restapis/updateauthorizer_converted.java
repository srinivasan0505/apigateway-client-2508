/**
 * MCP Server function for Updates an existing Authorizer resource.
 */
...
class Patch_Restapis_Restapi_Id_Authorizers_Authorizer_IdMCPTool {
    
    public static Function<MCPServer.MCPRequest, MCPServer.MCPToolResult> getPatch_Restapis_Restapi_Id_Authorizers_Authorizer_IdHandler(MCPServer.APIConfig config) {
        return (request) -> {
            try {
        ...
        if (args.containsKey("patchOperations")) {
            queryParams.add("patchOperations=" + args.get("patchOperations"));
                ...
                String url = config.getBaseUrl() + "/api/v2/patch_restapis_restapi_id_authorizers_authorizer_id" + queryString;
    ...
    public static MCPServer.Tool createPatch_Restapis_Restapi_Id_Authorizers_Authorizer_IdTool(MCPServer.APIConfig config) {
        ...
        MCPServer.ToolDefinition definition = new MCPServer.ToolDefinition(
            "patch_restapis_restapi_id_authorizers_authorizer_id",
            "Updates an existing Authorizer resource.",
            parameters
        );
        
        return new MCPServer.Tool(definition, getPatch_Restapis_Restapi_Id_Authorizers_Authorizer_IdHandler(config));
    }
