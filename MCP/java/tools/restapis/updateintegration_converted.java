/**
 * MCP Server function for Represents an update integration.
 */
...
class Patch_Restapis_Restapi_Id_Resources_Resource_Id_Methods_Http_Method_IntegrationMCPTool {
    
    public static Function<MCPServer.MCPRequest, MCPServer.MCPToolResult> getPatch_Restapis_Restapi_Id_Resources_Resource_Id_Methods_Http_Method_IntegrationHandler(MCPServer.APIConfig config) {
        return (request) -> {
            try {
        ...
        if (args.containsKey("patchOperations")) {
            queryParams.add("patchOperations=" + args.get("patchOperations"));
                ...
                String url = config.getBaseUrl() + "/api/v2/patch_restapis_restapi_id_resources_resource_id_methods_http_method_integration" + queryString;
    ...
    public static MCPServer.Tool createPatch_Restapis_Restapi_Id_Resources_Resource_Id_Methods_Http_Method_IntegrationTool(MCPServer.APIConfig config) {
        ...
        resource_idProperty.put("description", "Represents an update integration request's resource identifier.");
        ...
        http_methodProperty.put("description", "Represents an update integration request's HTTP method.");
        ...
        MCPServer.ToolDefinition definition = new MCPServer.ToolDefinition(
            "patch_restapis_restapi_id_resources_resource_id_methods_http_method_integration",
            "Represents an update integration.",
            parameters
        );
        
        return new MCPServer.Tool(definition, getPatch_Restapis_Restapi_Id_Resources_Resource_Id_Methods_Http_Method_IntegrationHandler(config));
    }
