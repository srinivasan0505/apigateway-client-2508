/**
 * MCP Server function for Changes information about the specified API.
 */
...
class Patch_Restapis_Restapi_IdMCPTool {
    
    public static Function<MCPServer.MCPRequest, MCPServer.MCPToolResult> getPatch_Restapis_Restapi_IdHandler(MCPServer.APIConfig config) {
        return (request) -> {
            try {
        ...
        if (args.containsKey("patchOperations")) {
            queryParams.add("patchOperations=" + args.get("patchOperations"));
                ...
                String url = config.getBaseUrl() + "/api/v2/patch_restapis_restapi_id" + queryString;
    ...
    public static MCPServer.Tool createPatch_Restapis_Restapi_IdTool(MCPServer.APIConfig config) {
        ...
        MCPServer.ToolDefinition definition = new MCPServer.ToolDefinition(
            "patch_restapis_restapi_id",
            "Changes information about the specified API.",
            parameters
        );
        
        return new MCPServer.Tool(definition, getPatch_Restapis_Restapi_IdHandler(config));
    }
