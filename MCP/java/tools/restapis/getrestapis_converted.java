/**
 * MCP Server function for Lists the RestApis resources for your collection.
 */
...
class Get_RestapisMCPTool {
    
    public static Function<MCPServer.MCPRequest, MCPServer.MCPToolResult> getGet_RestapisHandler(MCPServer.APIConfig config) {
        return (request) -> {
            try {
        ...
        if (args.containsKey("limit")) {
            queryParams.add("limit=" + args.get("limit"));
                ...
                String url = config.getBaseUrl() + "/api/v2/get_restapis" + queryString;
    ...
    public static MCPServer.Tool createGet_RestapisTool(MCPServer.APIConfig config) {
        ...
        return new MCPServer.Tool(definition, getGet_RestapisHandler(config));
    }
