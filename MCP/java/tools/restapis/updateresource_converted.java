/**
 * MCP Server function for Changes information about a Resource resource.
 */
...
class Patch_Restapis_Restapi_Id_Resources_Resource_IdMCPTool {
    
    public static Function<MCPServer.MCPRequest, MCPServer.MCPToolResult> getPatch_Restapis_Restapi_Id_Resources_Resource_IdHandler(MCPServer.APIConfig config) {
        return (request) -> {
            try {
        ...
        if (args.containsKey("patchOperations")) {
            queryParams.add("patchOperations=" + args.get("patchOperations"));
                ...
                String url = config.getBaseUrl() + "/api/v2/patch_restapis_restapi_id_resources_resource_id" + queryString;
    ...
    public static MCPServer.Tool createPatch_Restapis_Restapi_Id_Resources_Resource_IdTool(MCPServer.APIConfig config) {
        ...
        resource_idProperty.put("description", "The identifier of the Resource resource.");
        ...
        MCPServer.ToolDefinition definition = new MCPServer.ToolDefinition(
            "patch_restapis_restapi_id_resources_resource_id",
            "Changes information about a Resource resource.",
            parameters
        );
        
        return new MCPServer.Tool(definition, getPatch_Restapis_Restapi_Id_Resources_Resource_IdHandler(config));
    }
