/**
 * MCP Server function for Describes existing Models defined for a RestApi resource.
 */
...
class Get_Restapis_Restapi_Id_ModelsMCPTool {
    
    public static Function<MCPServer.MCPRequest, MCPServer.MCPToolResult> getGet_Restapis_Restapi_Id_ModelsHandler(MCPServer.APIConfig config) {
        return (request) -> {
            try {
        ...
        if (args.containsKey("limit")) {
            queryParams.add("limit=" + args.get("limit"));
                ...
                String url = config.getBaseUrl() + "/api/v2/get_restapis_restapi_id_models" + queryString;
    ...
    public static MCPServer.Tool createGet_Restapis_Restapi_Id_ModelsTool(MCPServer.APIConfig config) {
        ...
        MCPServer.ToolDefinition definition = new MCPServer.ToolDefinition(
            "get_restapis_restapi_id_models",
            "Describes existing Models defined for a RestApi resource.",
            parameters
        );
        
        return new MCPServer.Tool(definition, getGet_Restapis_Restapi_Id_ModelsHandler(config));
    }
