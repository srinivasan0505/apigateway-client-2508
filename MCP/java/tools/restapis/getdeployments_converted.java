/**
 * MCP Server function for Gets information about a Deployments collection.
 */
...
class Get_Restapis_Restapi_Id_DeploymentsMCPTool {
    
    public static Function<MCPServer.MCPRequest, MCPServer.MCPToolResult> getGet_Restapis_Restapi_Id_DeploymentsHandler(MCPServer.APIConfig config) {
        return (request) -> {
            try {
        ...
        if (args.containsKey("limit")) {
            queryParams.add("limit=" + args.get("limit"));
                ...
                String url = config.getBaseUrl() + "/api/v2/get_restapis_restapi_id_deployments" + queryString;
    ...
    public static MCPServer.Tool createGet_Restapis_Restapi_Id_DeploymentsTool(MCPServer.APIConfig config) {
        ...
        MCPServer.ToolDefinition definition = new MCPServer.ToolDefinition(
            "get_restapis_restapi_id_deployments",
            "Gets information about a Deployments collection.",
            parameters
        );
        
        return new MCPServer.Tool(definition, getGet_Restapis_Restapi_Id_DeploymentsHandler(config));
    }
