/**
 * MCP Server function for Creates a documentation version
 */
...
class Post_Restapis_Restapi_Id_Documentation_VersionsMCPTool {
    
    public static Function<MCPServer.MCPRequest, MCPServer.MCPToolResult> getPost_Restapis_Restapi_Id_Documentation_VersionsHandler(MCPServer.APIConfig config) {
        return (request) -> {
            try {
        ...
        if (args.containsKey("stageName")) {
            queryParams.add("stageName=" + args.get("stageName"));
                ...
                String url = config.getBaseUrl() + "/api/v2/post_restapis_restapi_id_documentation_versions" + queryString;
    ...
    public static MCPServer.Tool createPost_Restapis_Restapi_Id_Documentation_VersionsTool(MCPServer.APIConfig config) {
        ...
        descriptionProperty.put("description", "Input parameter: A description about the new documentation snapshot.");
        ...
        documentationVersionProperty.put("required", true);
        documentationVersionProperty.put("description", "Input parameter: The version identifier of the new snapshot.");
        ...
        stageNameProperty.put("description", "Input parameter: The stage name to be associated with the new documentation snapshot.");
        properties.put("stageName", stageNameProperty);
        parameters.put("properties", properties);
        
        MCPServer.ToolDefinition definition = new MCPServer.ToolDefinition(
            "post_restapis_restapi_id_documentation_versions",
            "Creates a documentation version",
            parameters
        );
        
        return new MCPServer.Tool(definition, getPost_Restapis_Restapi_Id_Documentation_VersionsHandler(config));
    }
