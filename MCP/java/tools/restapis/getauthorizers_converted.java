/**
 * MCP Server function for Describe an existing Authorizers resource.
 */
...
class Get_Restapis_Restapi_Id_AuthorizersMCPTool {
    
    public static Function<MCPServer.MCPRequest, MCPServer.MCPToolResult> getGet_Restapis_Restapi_Id_AuthorizersHandler(MCPServer.APIConfig config) {
        return (request) -> {
            try {
        ...
        if (args.containsKey("limit")) {
            queryParams.add("limit=" + args.get("limit"));
                ...
                String url = config.getBaseUrl() + "/api/v2/get_restapis_restapi_id_authorizers" + queryString;
    ...
    public static MCPServer.Tool createGet_Restapis_Restapi_Id_AuthorizersTool(MCPServer.APIConfig config) {
        ...
        MCPServer.ToolDefinition definition = new MCPServer.ToolDefinition(
            "get_restapis_restapi_id_authorizers",
            "Describe an existing Authorizers resource.",
            parameters
        );
        
        return new MCPServer.Tool(definition, getGet_Restapis_Restapi_Id_AuthorizersHandler(config));
    }
