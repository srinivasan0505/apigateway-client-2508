/**
 * MCP Server function for Represents an update integration response.
 */
...
class Patch_Restapis_Restapi_Id_Resources_Resource_Id_Methods_Http_Method_Integration_Responses_Status_CodeMCPTool {
    
    public static Function<MCPServer.MCPRequest, MCPServer.MCPToolResult> getPatch_Restapis_Restapi_Id_Resources_Resource_Id_Methods_Http_Method_Integration_Responses_Status_CodeHandler(MCPServer.APIConfig config) {
        return (request) -> {
            try {
        ...
        if (args.containsKey("patchOperations")) {
            queryParams.add("patchOperations=" + args.get("patchOperations"));
                ...
                String url = config.getBaseUrl() + "/api/v2/patch_restapis_restapi_id_resources_resource_id_methods_http_method_integration_responses_status_code" + queryString;
    ...
    public static MCPServer.Tool createPatch_Restapis_Restapi_Id_Resources_Resource_Id_Methods_Http_Method_Integration_Responses_Status_CodeTool(MCPServer.APIConfig config) {
        ...
        resource_idProperty.put("description", "Specifies an update integration response request's resource identifier.");
        ...
        http_methodProperty.put("description", "Specifies an update integration response request's HTTP method.");
        ...
        status_codeProperty.put("description", "Specifies an update integration response request's status code.");
        ...
        MCPServer.ToolDefinition definition = new MCPServer.ToolDefinition(
            "patch_restapis_restapi_id_resources_resource_id_methods_http_method_integration_responses_status_code",
            "Represents an update integration response.",
            parameters
        );
        
        return new MCPServer.Tool(definition, getPatch_Restapis_Restapi_Id_Resources_Resource_Id_Methods_Http_Method_Integration_Responses_Status_CodeHandler(config));
    }
