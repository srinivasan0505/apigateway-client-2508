/**
 * MCP Server function for Gets the RequestValidators collection of a given RestApi.
 */
...
class Get_Restapis_Restapi_Id_RequestvalidatorsMCPTool {
    
    public static Function<MCPServer.MCPRequest, MCPServer.MCPToolResult> getGet_Restapis_Restapi_Id_RequestvalidatorsHandler(MCPServer.APIConfig config) {
        return (request) -> {
            try {
        ...
        if (args.containsKey("limit")) {
            queryParams.add("limit=" + args.get("limit"));
                ...
                String url = config.getBaseUrl() + "/api/v2/get_restapis_restapi_id_requestvalidators" + queryString;
    ...
    public static MCPServer.Tool createGet_Restapis_Restapi_Id_RequestvalidatorsTool(MCPServer.APIConfig config) {
        ...
        MCPServer.ToolDefinition definition = new MCPServer.ToolDefinition(
            "get_restapis_restapi_id_requestvalidators",
            "Gets the RequestValidators collection of a given RestApi.",
            parameters
        );
        
        return new MCPServer.Tool(definition, getGet_Restapis_Restapi_Id_RequestvalidatorsHandler(config));
    }
