/**
 * MCP Server function for Describe an existing Method resource.
 */
...
class Get_Restapis_Restapi_Id_Resources_Resource_Id_Methods_Http_MethodMCPTool {
    
    public static Function<MCPServer.MCPRequest, MCPServer.MCPToolResult> getGet_Restapis_Restapi_Id_Resources_Resource_Id_Methods_Http_MethodHandler(MCPServer.APIConfig config) {
        return (request) -> {
            try {
        ...
        if (args.containsKey("http_method")) {
            queryParams.add("http_method=" + args.get("http_method"));
                ...
                String url = config.getBaseUrl() + "/api/v2/get_restapis_restapi_id_resources_resource_id_methods_http_method" + queryString;
    ...
    public static MCPServer.Tool createGet_Restapis_Restapi_Id_Resources_Resource_Id_Methods_Http_MethodTool(MCPServer.APIConfig config) {
        ...
        MCPServer.ToolDefinition definition = new MCPServer.ToolDefinition(
            "get_restapis_restapi_id_resources_resource_id_methods_http_method",
            "Describe an existing Method resource.",
            parameters
        );
        
        return new MCPServer.Tool(definition, getGet_Restapis_Restapi_Id_Resources_Resource_Id_Methods_Http_MethodHandler(config));
    }
