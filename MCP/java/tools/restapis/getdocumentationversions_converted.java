/**
 * MCP Server function for Gets documentation versions.
 */
...
class Get_Restapis_Restapi_Id_Documentation_VersionsMCPTool {
    
    public static Function<MCPServer.MCPRequest, MCPServer.MCPToolResult> getGet_Restapis_Restapi_Id_Documentation_VersionsHandler(MCPServer.APIConfig config) {
        return (request) -> {
            try {
        ...
        if (args.containsKey("limit")) {
            queryParams.add("limit=" + args.get("limit"));
                ...
                String url = config.getBaseUrl() + "/api/v2/get_restapis_restapi_id_documentation_versions" + queryString;
    ...
    public static MCPServer.Tool createGet_Restapis_Restapi_Id_Documentation_VersionsTool(MCPServer.APIConfig config) {
        ...
        MCPServer.ToolDefinition definition = new MCPServer.ToolDefinition(
            "get_restapis_restapi_id_documentation_versions",
            "Gets documentation versions.",
            parameters
        );
        
        return new MCPServer.Tool(definition, getGet_Restapis_Restapi_Id_Documentation_VersionsHandler(config));
    }
