/**
 * MCP Server function for Changes information about the current Account resource.
 */
...
class Patch_AccountMCPTool {
    
    public static Function<MCPServer.MCPRequest, MCPServer.MCPToolResult> getPatch_AccountHandler(MCPServer.APIConfig config) {
        return (request) -> {
            try {
        ...
        if (args.containsKey("patchOperations")) {
            queryParams.add("patchOperations=" + args.get("patchOperations"));
                ...
                String url = config.getBaseUrl() + "/api/v2/patch_account" + queryString;
    ...
    public static MCPServer.Tool createPatch_AccountTool(MCPServer.APIConfig config) {
        ...
        return new MCPServer.Tool(definition, getPatch_AccountHandler(config));
    }
