/**
 * MCP Server function for Represents a collection of DomainName resources.
 */
...
class Get_DomainnamesMCPTool {
    
    public static Function<MCPServer.MCPRequest, MCPServer.MCPToolResult> getGet_DomainnamesHandler(MCPServer.APIConfig config) {
        return (request) -> {
            try {
        ...
        if (args.containsKey("limit")) {
            queryParams.add("limit=" + args.get("limit"));
                ...
                String url = config.getBaseUrl() + "/api/v2/get_domainnames" + queryString;
    ...
    public static MCPServer.Tool createGet_DomainnamesTool(MCPServer.APIConfig config) {
        ...
        return new MCPServer.Tool(definition, getGet_DomainnamesHandler(config));
    }
