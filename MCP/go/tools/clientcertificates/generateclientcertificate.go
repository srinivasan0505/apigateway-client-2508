...
func GenerateclientcertificateHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var requestBody models.GenerateClientCertificaterequest
		...
		url := fmt.Sprintf("%s/clientcertificates", cfg.BaseURL)
...
func CreateGenerateclientcertificateTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_clientcertificates",
		mcp.WithDescription("Generates a ClientCertificate resource."),
		...
		mcp.WithString("description", mcp.Description("Input parameter: The description of the ClientCertificate.")),
	...
	return models.Tool{
		Definition: tool,
		Handler:    GenerateclientcertificateHandler(cfg),
	}
}
