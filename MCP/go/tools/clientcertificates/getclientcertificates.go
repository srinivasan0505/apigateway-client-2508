...
func GetclientcertificatesHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/clientcertificates%s", cfg.BaseURL, queryString)
		...
		var result models.ClientCertificates
...
func CreateGetclientcertificatesTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_clientcertificates",
		mcp.WithDescription("Gets a collection of ClientCertificate resources."),
	...
	return models.Tool{
		Definition: tool,
		Handler:    GetclientcertificatesHandler(cfg),
	}
}
