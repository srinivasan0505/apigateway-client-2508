...
func UpdatemethodHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateUpdatemethodTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("patch_restapis_restapi_id_resources_resource_id_methods_http_method",
		mcp.WithDescription("Updates an existing Method resource."),
	...
	return models.Tool{
		Definition: tool,
		Handler:    UpdatemethodHandler(cfg),
	}
}
