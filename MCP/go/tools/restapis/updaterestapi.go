...
func UpdaterestapiHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/restapis/%s", cfg.BaseURL, restapi_id)
...
func CreateUpdaterestapiTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("patch_restapis_restapi_id",
		mcp.WithDescription("Changes information about the specified API."),
	...
	return models.Tool{
		Definition: tool,
		Handler:    UpdaterestapiHandler(cfg),
	}
}
