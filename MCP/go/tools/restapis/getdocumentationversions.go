...
func GetdocumentationversionsHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/restapis/%s/documentation/versions%s", cfg.BaseURL, restapi_id, queryString)
		...
		var result models.DocumentationVersions
...
func CreateGetdocumentationversionsTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_restapis_restapi_id_documentation_versions",
		mcp.WithDescription("Gets documentation versions."),
	...
	return models.Tool{
		Definition: tool,
		Handler:    GetdocumentationversionsHandler(cfg),
	}
}
