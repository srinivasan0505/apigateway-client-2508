...
func GetrestapisHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/restapis%s", cfg.BaseURL, queryString)
...
func CreateGetrestapisTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_restapis",
		mcp.WithDescription("Lists the RestApis resources for your collection."),
	...
	return models.Tool{
		Definition: tool,
		Handler:    GetrestapisHandler(cfg),
	}
}
