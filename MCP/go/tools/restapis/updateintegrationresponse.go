...
func UpdateintegrationresponseHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateUpdateintegrationresponseTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("patch_restapis_restapi_id_resources_resource_id_methods_http_method_integration_responses_status_code",
		mcp.WithDescription("Represents an update integration response."),
		...
		mcp.WithString("resource_id", mcp.Required(), mcp.Description("Specifies an update integration response request's resource identifier.")),
		mcp.WithString("http_method", mcp.Required(), mcp.Description("Specifies an update integration response request's HTTP method.")),
		mcp.WithString("status_code", mcp.Required(), mcp.Description("Specifies an update integration response request's status code.")),
	...
	return models.Tool{
		Definition: tool,
		Handler:    UpdateintegrationresponseHandler(cfg),
	}
}
