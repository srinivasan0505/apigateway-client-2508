...
func CreateDeletemodelTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_restapis_restapi_id_models_model_name",
		mcp.WithDescription("Deletes a model."),
		...
		mcp.WithString("model_name", mcp.Required(), mcp.Description("The name of the model to delete.")),
	)
