...
func DeleteresourceHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateDeleteresourceTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("delete_restapis_restapi_id_resources_resource_id",
		mcp.WithDescription("Deletes a Resource resource."),
	...
	return models.Tool{
		Definition: tool,
		Handler:    DeleteresourceHandler(cfg),
	}
}
