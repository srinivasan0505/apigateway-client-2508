...
func UpdateapikeyHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/apikeys/%s", cfg.BaseURL, api_Key)
...
func CreateUpdateapikeyTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("patch_apikeys_api_Key",
		mcp.WithDescription("Changes information about an ApiKey resource."),
		...
		mcp.WithString("api_Key", mcp.Required(), mcp.Description("The identifier of the ApiKey resource to be updated.")),
	...
	return models.Tool{
		Definition: tool,
		Handler:    UpdateapikeyHandler(cfg),
	}
}
