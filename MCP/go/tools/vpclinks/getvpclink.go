...
func GetvpclinkHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateGetvpclinkTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_vpclinks_vpclink_id",
		mcp.WithDescription("Gets a specified VPC link under the caller's account in a region."),
