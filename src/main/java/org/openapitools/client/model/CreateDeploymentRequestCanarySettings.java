...
public class CreateDeploymentRequestCanarySettings {
  ...
  public CreateDeploymentRequestCanarySettings percentTraffic(@javax.annotation.Nullable Double percentTraffic) {
  ...
  public CreateDeploymentRequestCanarySettings stageVariableOverrides(@javax.annotation.Nullable Map stageVariableOverrides) {
  ...
  public CreateDeploymentRequestCanarySettings useStageCache(@javax.annotation.Nullable Boolean useStageCache) {
