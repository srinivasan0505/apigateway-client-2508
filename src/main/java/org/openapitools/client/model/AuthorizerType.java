 ...
 */
@JsonAdapter(AuthorizerType.Adapter.class)
public enum AuthorizerType {
  ...
  public static AuthorizerType fromValue(String value) {
    for (AuthorizerType b : AuthorizerType.values()) {
  ...
  public static class Adapter extends TypeAdapter<AuthorizerType> {
    @Override
    public void write(final JsonWriter jsonWriter, final AuthorizerType enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public AuthorizerType read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return AuthorizerType.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    AuthorizerType.fromValue(value);
  }
}
