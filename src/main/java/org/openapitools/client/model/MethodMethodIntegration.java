...
public class MethodMethodIntegration {
  ...
  public MethodMethodIntegration type(@javax.annotation.Nullable IntegrationType type) {
    this.type = type;
    return this;
  }
  ...
  public MethodMethodIntegration httpMethod(@javax.annotation.Nullable String httpMethod) {
  ...
  public MethodMethodIntegration uri(@javax.annotation.Nullable String uri) {
    this.uri = uri;
    return this;
  }
  ...
  public MethodMethodIntegration connectionType(@javax.annotation.Nullable ConnectionType connectionType) {
  ...
  public MethodMethodIntegration connectionId(@javax.annotation.Nullable String connectionId) {
  ...
  public MethodMethodIntegration credentials(@javax.annotation.Nullable String credentials) {
  ...
  public MethodMethodIntegration requestParameters(@javax.annotation.Nullable Map requestParameters) {
  ...
  public MethodMethodIntegration requestTemplates(@javax.annotation.Nullable Map requestTemplates) {
  ...
  public MethodMethodIntegration passthroughBehavior(@javax.annotation.Nullable String passthroughBehavior) {
  ...
  public MethodMethodIntegration contentHandling(@javax.annotation.Nullable ContentHandlingStrategy contentHandling) {
  ...
  public MethodMethodIntegration timeoutInMillis(@javax.annotation.Nullable Integer timeoutInMillis) {
  ...
  public MethodMethodIntegration cacheNamespace(@javax.annotation.Nullable String cacheNamespace) {
  ...
  public MethodMethodIntegration cacheKeyParameters(@javax.annotation.Nullable List cacheKeyParameters) {
  ...
  public MethodMethodIntegration integrationResponses(@javax.annotation.Nullable Map integrationResponses) {
  ...
  public MethodMethodIntegration tlsConfig(@javax.annotation.Nullable IntegrationTlsConfig tlsConfig) {
